...
$query1 = 'SELECT *, ID as imageID from user_post where ID = '.$_GET['id'].'';
        ...
        <div>
            <div class="form">
                ...
                <div class="logo1"><center><img src="components/pics/uniqquologo.png" alt=""></center></div>
                    <input type="hidden" name="id" value="<?php echo $row2['imageID'] ?>">
                    <!-- Input for Image -->
                    
                    <img style="width:200px; height:200px; position:relative; transform:translateX(110px)" id="chosen-image" src="<?php echo $row2['art_image'] ?>" alt="Chosen Image">
        
                    <!-- Input for Description -->
                    <label for="description">Description:</label>
                    <textarea name="description" rows="4" required><?php echo $row2['description'] ?></textarea>
        
                    <!-- Input for Name -->
                    <label for="name">Name:</label>
                    <input type="text" name="name" id="name" value="<?php echo $row2['art_title'] ?>">

...
<body>
    ...
    <div style="display: flex;">
        ...
        <div>
            <div class="form">
                <form action="updateprofback.php"  enctype="multipart/form-data" method="post">
                <div class="logo1"><center><img id="chosen-image" src="<?php echo $row1['profile_pic'] ?>" alt="Chosen Image"></center></div>
                    ...
                    <input type="text" name="name" id="name" value="<?php echo $row1['username'] ?>">
